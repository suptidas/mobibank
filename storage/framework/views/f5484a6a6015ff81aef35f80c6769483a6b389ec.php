...
<body>
	...
	<table border="1">
		...
		<tr>
			...
			<td>
			<a href="<?php echo e(route('manager.custDetails', $employees[$i]['id'])); ?>">Details</a> |
			<a href="<?php echo e(route('manager.custEdit', $employees[$i]['id'])); ?>">Edit</a> |
...
</html><?php /**PATH S:\Fall2020\ATP_3\FINAL\Final Project\Marge\project\resources\views/manager/custlist.blade.php ENDPATH**/ ?>