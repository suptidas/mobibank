...
public function custUpdate($id, empRequest $req)
    ...
    public function custDestroy($id){
     ...
     return redirect()->route('manager.custlist');
      ...
      return view('manager.custTransacList')->with('employees', $employees);
    }

      public function pdfdownload(){

      $employees=Manager::all();
      $pdf=PDF::loadView('/manager/custTransacList', compact('employees'));
      return $pdf->download('Customer_Transaction_List.pdf');
    }
