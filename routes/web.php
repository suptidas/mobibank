...
Route::get('/manager/seeTransaction',         'managerController@seeTransaction')->name('manager.seeTransaction');

Route::get('/manager/pdfdownload',         'managerController@pdfdownload')->name('manager.pdfdownload');
